...
@ActiveProfiles("TEST")
@ContextConfiguration(classes = BasePaymentsRepositoryTest.MiniApplication.class)
@TestExecutionListeners({
        DependencyInjectionTestExecutionListener.class,
        DirtiesContextTestExecutionListener.class,
        TransactionalTestExecutionListener.class
})
public abstract class BasePaymentsRepositoryTest {
    ...
    @EntityScan(basePackages = {
            "com.soaesps.payments.domain",
            "com.soaesps.payments.DataModels"
    })
